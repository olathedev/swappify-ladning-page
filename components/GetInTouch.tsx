...
const GetInTouch = () => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      setIsLoading(false);
      toast.success(
        "Thank you for contacting suwappify support, we will revert shortly"
      );
      reset();
    } catch (error) {
      console.error(error);
      ...
      <div className="md:w-1/2 flex flex-col md:gap-16">
        ...
        <div className="hidden md:flex flex-col gap-6 text-sm md:text-xl ">
          <div className="flex gap-6 items-center">
            ...
            Swapify HQ, Laki 24/2, 12915 Tallinn, Estonia
          </div>
      ...
      <div className="md:w-1/2">
        ...
        >
          <div className="w-full">
            ...
            <input
              type="text"
              className="w-full p-2.5 rounded-lg border border-[#5F5F53]"
          ...
          <div className="w-full flex flex-col">
            ...
            <textarea
              ...
              className="h-[139px] border border-[#5F5F53] rounded-lg p-3 py-3"
              {...register("message")}
            ></textarea>
            {errors.message && (
              <p className="text-sm text-red-500">
          ...
          <button className="bg-[#50644C] py-3 px-6 rounded-xl text-white flex justify-center items-center gap-3 md:text-lg transition duration-200 hover:bg-[#738370]">
            {!isLoading ? (
              <>
                Send message
                <ArrowRight />
