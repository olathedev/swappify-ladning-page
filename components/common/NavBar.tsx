        ...
        <ul className="cursor-pointer flex w-[468px] justify-between text-primary">
          {navItems.map((item, index) => (
            <li
              ...
              } hover:text-black/20 transition duration-200`}
            >
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col h-full p-6">
            ...
            <ul className="flex flex-col space-y-6 mt-8 text-primary hover:text-black/20 transition duration-200">
              <li>
