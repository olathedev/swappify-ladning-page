  ...
  return (
    <footer className=' w-full bg-[#5F5F53] text-white py-6'>
      <div className="container mx-auto px-4 md:px-20 flex flex-col md:flex-row justify-between">
        ...
        <div className='flex flex-col gap-2 md:gap-4 text-sm md:text-base mt-6 md:mt-0'>
          <h4 className='font-bold text-base'>Join our waitlist</h4>
      ...
      <div className="mt-6 container mx-auto px-6 md:px-20 flex flex-col">
        <div className="flex mb-3 gap-4">
          <a href='https://www.instagram.com/swapify_ou/' target='_blank'>
          ...
          <a href="https://www.linkedin.com/company/swapify-ou/" target='_blank'>
