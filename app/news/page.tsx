...
const page = () => {
    return (
        <div className='w-full bg- bg-cover bg-center'>
            <div className="bg-white bg-opacity-80">
                <NavBar />
                <hr />
                <div className='container mx-auto px-6 md:px-10 py-20 h-screen flex flex-col space-y-10'>
                    <header>
                        <h1 className='text-3xl font-bold mb-2'>What's New at Swapify</h1>
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-[794px] flex flex-col">
                            ...
                            <div className="inline-flex items-center gap-2 text-primary my-2">
